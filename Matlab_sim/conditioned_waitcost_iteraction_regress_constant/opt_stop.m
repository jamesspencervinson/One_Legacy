...
donor_info = table2array(readtable('donor_info.csv'));
...
para_init=[10;5;3;0;0;0;-1;-1;-1;0;0]; % initial guess of the parameters
options=optimset('Display','iter','MaxFunEvals',1e5,'MaxIter',1e5,'TolFun',1e-6,'TolX',1e-4);

gs = GlobalSearch;
llmin = @(para) log_ll(para, wait_cost, beta, T, N, n, ...
